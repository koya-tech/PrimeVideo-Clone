...
function MovieLargerRow({ category, requestedUrl }: MovieRowPropsType) {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            try {
                ...
                if (type === "tv") {
                    setMovies(
                        (data.results as TmdbTvType[]).map((tv) =>
                            transformFromTvTypeToContentType(tv)
                        )
                    );
                } else {
    ...
    if (loading) return <Skeleton className="h-[125px] w-10/12 mx-auto my-4 rounded-xl" />;
                                                    ...
                                                    <div className="group relative">
                                                        ...
                                                        <div className="relative z-0 group-hover:z-10">
                                                            ...
                                                            <img
                                                                ...
                                                                w-72 object-cover transition-transform duration-300 rounded-md group-hover:scale-110
